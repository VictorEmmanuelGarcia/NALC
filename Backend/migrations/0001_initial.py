    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record_type', models.IntegerField(choices=[(1, 'Proposal'), (2, 'Thesis/Research'), (3, 'Project')])),
                ('classification', models.IntegerField(choices=[(1, 'Basic Research'), (2, 'Applied Research')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, default='', max_length=191, unique=True)),
